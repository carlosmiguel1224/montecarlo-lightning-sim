...
def run_sim_revised(samples,z_max,shape_info, all_shapes, XBOUNDS, YBOUNDS, meters=True, area_for_floor=None, pos_min=4,neg_min=4,pos_max=400,neg_max=200,curtoradpos=None,curtoradneg=None):
    samples = samples
    delta = 50
    ...
    object_bboxes = [(i ,shape, get_bbox(shape)) for shape, i in visible_shapes]
    ...
    for i in range(samples):
        ...
        while True:
            ...
            index ,distance, groundpoint = modified_tolerance_abs_min_dist_visible(vertex, candidate_shapes)
